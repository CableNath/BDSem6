...
BEGIN
    ...
    LOOP
        ...
        (
            ...
            FROM ALL_INDEXES
            JOIN ALL_IND_COLUMNS ON ALL_IND_COLUMNS.INDEX_NAME = 'TEST_INDEX2'--dev_schema_index.INDEX_NAME
            WHERE ALL_INDEXES.OWNER = 'DEV_SCHEMA' AND ALL_INDEXES.INDEX_NAME = 'TEST_INDEX2'--dev_schema_index.INDEX_NAME
                AND NOT REGEXP_LIKE (ALL_INDEXES.INDEX_NAME, '^SYS_|^BIN_')
            MINUS
            SELECT ALL_INDEXES.TABLE_NAME, ALL_INDEXES.INDEX_TYPE, ALL_INDEXES.UNIQUENESS, ALL_IND_COLUMNS.COLUMN_NAME
            FROM ALL_INDEXES
            JOIN ALL_IND_COLUMNS ON ALL_IND_COLUMNS.INDEX_NAME = 'TEST_INDEX2'--dev_schema_index.INDEX_NAME
            WHERE ALL_INDEXES.OWNER = 'PROD_SCHEMA' AND ALL_INDEXES.INDEX_NAME = 'TEST_INDEX2'--dev_schema_index.INDEX_NAME
                AND NOT REGEXP_LIKE (ALL_INDEXES.INDEX_NAME, '^SYS_|^BIN_'))
            UNION
            (SELECT ALL_INDEXES.TABLE_NAME, ALL_INDEXES.INDEX_TYPE, ALL_INDEXES.UNIQUENESS, ALL_IND_COLUMNS.COLUMN_NAME
            FROM ALL_INDEXES
