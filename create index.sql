...
CREATE INDEX prod_schema.TEST_INDEX4 on prod_schema.t5_dev_prod_dif_struct(sex);
CREATE INDEX prod_schema.TEST_INDEX5 on prod_schema.t6_dev_prod_dif_struct(age);



drop index prod_schema.TEST_INDEX1;
drop index prod_schema.TEST_INDEX4;
drop index prod_schema.TEST_INDEX5;
